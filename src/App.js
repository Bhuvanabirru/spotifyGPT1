...
function App() {
  ...
  const fetchUserData = async (accessToken) => {
    try {
      ...
      console.error("Failed to fetch user data status:", error.response?.status);
      console.error("Failed to fetch user data body:", error.response?.data);
      console.error(error.message);
    }
  };
  ...
  const createAndSavePlaylist = async () => {
    try {
      ...
      console.error("Failed to create and save the playlist status:", error.response?.status);
      console.error("Failed to create and save the playlist body:", error.response?.data);
      console.error(error.message);
    }
  };
